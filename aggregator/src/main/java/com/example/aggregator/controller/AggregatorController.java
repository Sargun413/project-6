...
public class AggregatorController {
    ...
    @GetMapping("/getDefinitionFor/{getAllPalindromes}")
    List<Entry> getAllPalindrome(@PathVariable List<Entry> getAllPalindromes) {
        return (List<Entry>) service.getDefinitionFor(getAllPalindromes.toString());
    }
